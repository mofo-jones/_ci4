...
class Capa extends KiController {
...
//        var_export(,$v , TRUE);
    ...
    public function getList() {
        ...
        log_msg(var_export($capaModel->findAll(), true), 'sdfsdfsd', true);
        
        
        
        return json_encode(array('data' => $capaModel->findAll()));
    }
...
//        $cardModel = new CardModel();
//        $card      = $cardModel->find($json->id);
//
//        log_msg(var_export($card, TRUE));
//
//
//        return json_encode(array('data' => array('card' => $card, 'success' => true, 'error' => '---')));
////        }
//    }
